      ...
      <div className="p-8 pb-16 min-h-screen bg-surface">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          ...
          <div className="relative overflow-hidden bg-surface-container-lowest rounded-xl p-5 border-l-8 border-secondary-fixed-dim shadow-sm hover:shadow-md transition-shadow flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-[9px] font-label font-bold uppercase tracking-[0.2em] text-on-surface-variant mb-1">Producción Total</p>
            ...
            <div className="text-right">
              ...
              <div className="mt-1 flex items-center justify-end text-xs">
                ...
                <span className="ml-2 text-stone-500 font-label uppercase text-[9px] tracking-widest font-medium hidden sm:inline">vs ayer</span>
              </div>
            </div>
          </div>
        ...
        <section className="bg-surface-container-low rounded-2xl overflow-hidden shadow-sm border border-outline-variant/10">
          <div className="px-8 py-6 flex justify-between items-center bg-surface-container-highest/40">
            <div>
              <h4 className="text-xl font-headline font-bold text-on-surface">Detalles de Registro</h4>
              <p className="text-[11px] text-on-surface-variant font-label uppercase mt-1 tracking-[0.15em] font-bold">Historial de Lotes de Producción</p>
            </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-surface-container-highest/20 border-y border-outline-variant/20">
                  <th className="px-10 py-5 font-label uppercase text-[11px] tracking-[0.15em] font-bold text-on-surface-variant">Fecha/Hora</th>
                  <th className="px-10 py-5 font-label uppercase text-[11px] tracking-[0.15em] font-bold text-on-surface-variant">ID de Lote</th>
                  <th className="px-10 py-5 font-label uppercase text-[11px] tracking-[0.15em] font-bold text-on-surface-variant text-right">Hallulla (Unidades)</th>
                  <th className="px-10 py-5 font-label uppercase text-[11px] tracking-[0.15em] font-bold text-on-surface-variant text-right">Francés (Unidades)</th>
                  <th className="px-10 py-5 font-label uppercase text-[11px] tracking-[0.15em] font-bold text-on-surface-variant">Estado</th>
                  <th className="px-10 py-5 font-label uppercase text-[11px] tracking-[0.15em] font-bold text-on-surface-variant">Registrado Por</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-outline-variant/10">
                <tr className="bg-surface hover:bg-primary-fixed/10 transition-colors">
                  <td className="px-10 py-6 text-sm font-medium text-on-surface">Hoy, 10:45 AM</td>
                  ...
                  <td className="px-10 py-6">
                    <span className="bg-tertiary text-white px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest">En Horno</span>
                  </td>
                  <td className="px-10 py-6 text-sm font-medium text-on-surface-variant">M. Rodriguez</td>
                </tr>
                <tr className="bg-surface hover:bg-primary-fixed/10 transition-colors">
                  <td className="px-10 py-6 text-sm font-medium text-on-surface">Hoy, 08:20 AM</td>
                  ...
                  <td className="px-10 py-6">
                    <span className="bg-secondary-fixed text-on-secondary-container px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest">Listo</span>
                  </td>
