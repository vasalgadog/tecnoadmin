    ...
    <form onSubmit={(e) => e.preventDefault()} className="bg-surface-container-lowest p-8 rounded-xl ambient-shadow">
      ...
      <div className="space-y-1 mb-5">
        ...
        <div className="relative">
          ...
          <input required className="w-full bg-surface-container-high border-none rounded-lg py-2 pl-9 pr-3 text-sm font-bold focus:ring-2 focus:ring-primary placeholder:text-outline-variant" placeholder="Enter weight..." type="number" />
        </div>
      </div>
