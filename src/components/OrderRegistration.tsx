      ...
      <form className="space-y-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-1">
            ...
            <input className="w-full bg-surface-container-highest border-b-2 border-transparent focus:border-primary border-t-0 border-x-0 rounded-t-sm focus:ring-0 text-sm py-2 transition-colors text-on-surface" placeholder="John Doe" type="text" />
          </div>
          <div className="space-y-1">
            <label className="block text-[10px] font-label uppercase tracking-wider text-outline px-1">Phone Number</label>
            <input className="w-full bg-surface-container-highest border-b-2 border-transparent focus:border-primary border-t-0 border-x-0 rounded-t-sm focus:ring-0 text-sm py-2 transition-colors text-on-surface" placeholder="+56 9 ..." type="tel" />
          </div>
          <div className="space-y-1">
            <label className="block text-[10px] font-label uppercase tracking-wider text-outline px-1">Delivery Date</label>
            <input className="w-full bg-surface-container-highest border-b-2 border-transparent focus:border-primary border-t-0 border-x-0 rounded-t-sm focus:ring-0 text-sm py-2 transition-colors text-on-surface" type="date" />
          </div>
          <div className="space-y-1">
            <label className="block text-[10px] font-label uppercase tracking-wider text-outline px-1">Delivery Time</label>
            <input className="w-full bg-surface-container-highest border-b-2 border-transparent focus:border-primary border-t-0 border-x-0 rounded-t-sm focus:ring-0 text-sm py-2 transition-colors text-on-surface" type="time" />
          </div>
        </div>
        ...
        <div className="bg-surface-container-highest/60 rounded-lg p-3 border border-outline-variant/30 flex justify-between items-center group hover:border-primary/30 transition-colors">
          ...
          <span className="text-xl font-headline font-extrabold text-primary">$ 0</span>
        </div>
          ...
          <div className={`overflow-hidden transition-all duration-300 ease-in-out ${paymentStatus === 'abono' ? 'max-h-24 opacity-100 mt-3' : 'max-h-0 opacity-0'}`}>
            <div className="space-y-1">
              ...
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 font-bold text-outline text-sm">$</span>
                <input 
                  className="w-full bg-surface-container-highest border-b-2 border-secondary border-t-0 border-x-0 rounded-t-sm focus:ring-0 text-base font-bold py-2 pl-7 transition-colors text-on-surface" 
                  placeholder="0" 
                  type="number" 
